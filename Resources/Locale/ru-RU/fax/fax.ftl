...
fax-machine-popup-paper-loaded-normal = Загружена обычная бумага для копий. Запас: { $count }.
fax-machine-popup-paper-loaded-office = Загружена офисная бумага для копий. Запас: { $count }.
...
fax-machine-ui-paper-stock = Запас - Обычная: { $normal }, Офисная: { $office }
fax-machine-ui-take-normal-paper-button = Взять обычную
fax-machine-ui-take-office-paper-button = Взять офисную
