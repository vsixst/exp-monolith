...
ent-FaxMachineShipMcCargo = { ent-FaxMachineBase }
    ...
    .desc = { ent-FaxMachineBase.desc }
ent-FaxMachineNFMedicalDispatch = Edison Power Plant
ent-FaxMachineNFEdison = Bahama Mama's
ent-FaxMachineNFTradeMallNFSD = Trade Mall STC
ent-FaxMachineNFSyndicateVessel = Medical Dispatch
ent-FaxMachineNFTradeSTC = Trade Outpost
ent-FaxMachineNFTradeMallSTC = Trade Outpost STC
ent-FaxMachineNFBahama = TSFMC Outpost Lawyer
