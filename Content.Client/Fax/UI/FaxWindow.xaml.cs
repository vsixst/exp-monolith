...
public sealed partial class FaxWindow : DefaultWindow
{
    ...
    public event Action? TakeNormalPaperPressed;
    public event Action? TakeOfficePaperPressed;
    ...
    public FaxWindow()
    {
        ...
        TakeNormalPaperButton.OnPressed += _ => TakeNormalPaperPressed?.Invoke();
        TakeOfficePaperButton.OnPressed += _ => TakeOfficePaperPressed?.Invoke();
    ...
    public void UpdateState(FaxUiState state)
    {
        ...
        PaperStockLabel.Text = Loc.GetString("fax-machine-ui-paper-stock",
            ("normal", state.NormalPaperStock),
            ("office", state.OfficePaperStock));
